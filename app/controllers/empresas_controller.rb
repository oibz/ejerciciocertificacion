class EmpresasController < ApplicationController
  ...
  def index
    @empresas = Empresa.where(:user_empresas_id => current_user_empresa.id)
  end
  ...
  private
    ...
    def empresa_params
      params.require(:empresa).permit(:rut, :razon_social, :representante_legal, :direccion, :telefono, :user_empresas_id)
    end
end
